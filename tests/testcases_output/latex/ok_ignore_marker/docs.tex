...
\label{ok_ignore_marker}
\index{ok{\_}ignore{\_}marker}
\section{Overview}
\begin{description}
\item[\texttt{P}]
\end{description}
...
\ifpdf
\subsection*{\large{\textbf{P}}\normalsize\hspace{1ex}\hrulefill}
\else
\subsection*{P}
\fi
\label{ok_ignore_marker-P}
\index{P}
\begin{list}{}{
