...
\fi
\begin{ttfamily}
implicit property MyProperty: Integer read MyField write MyField;\end{ttfamily}
...
\fi
\begin{ttfamily}
implicit MyField: Integer;\end{ttfamily}
...
\fi
\begin{ttfamily}
implicit procedure MyMethod;\end{ttfamily}
