...
\end{description}
\begin{description}
\item[\texttt{Test}]Give \begin{ttfamily}TMyFunction\end{ttfamily}(\ref{ok_link_function_type-TMyFunction}) and \begin{ttfamily}TMyRecord\end{ttfamily}(\ref{ok_link_function_type.TMyRecord}) to test it.
\end{description}
