...
\label{ok_array_parameters}
\index{ok{\_}array{\_}parameters}
\section{Overview}
\begin{description}
\item[\texttt{Foo}]
\item[\texttt{Bar}]\begin{ttfamily}Foo(array of string, array of Integer, file of TObject)\end{ttfamily}(\ref{ok_array_parameters-Foo})
\end{description}
