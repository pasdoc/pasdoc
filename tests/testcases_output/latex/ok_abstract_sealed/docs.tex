...
\section{Overview}
\begin{description}
\item[\texttt{\begin{ttfamily}TOrdinaryClass\end{ttfamily} Class}]description of \begin{ttfamily}TOrdinaryClass\end{ttfamily}
\item[\texttt{\begin{ttfamily}TAbstractClass\end{ttfamily} Class}]description of \begin{ttfamily}TAbstractClass\end{ttfamily}
\item[\texttt{\begin{ttfamily}TSealedClass\end{ttfamily} Class}]description of \begin{ttfamily}TSealedClass\end{ttfamily}
\end{description}
