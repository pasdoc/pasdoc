...
\section{Overview}
\begin{description}
\item[\texttt{\begin{ttfamily}TMyRecord\end{ttfamily} Record}]Record fields are not sorted
\item[\texttt{\begin{ttfamily}TMyClass\end{ttfamily} Class}]Class fields are sorted
\end{description}
