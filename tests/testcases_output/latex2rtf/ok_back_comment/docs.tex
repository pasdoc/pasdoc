...
\section{Overview}
\begin{description}
\item[\texttt{\begin{ttfamily}TMyClass\end{ttfamily} Class}]Description of TMyClass
\item[\texttt{\begin{ttfamily}TMyException1\end{ttfamily} Class}]Description of TMyException1
\item[\texttt{\begin{ttfamily}TMyException2\end{ttfamily} Class}]Description of TMyException2
\end{description}
\begin{description}
\item[\texttt{Foo}]Description of Foo, (\begin{ttfamily}Foo\end{ttfamily})
\end{description}
