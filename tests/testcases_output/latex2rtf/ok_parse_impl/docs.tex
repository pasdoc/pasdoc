...
\end{description}
\begin{description}
\item[\texttt{Foo}]This is Foo (intf) This is Foo (impl)
\item[\texttt{Bar}]This is Bar (impl)
\item[\texttt{Laz}]This is Laz And it must not be doubled
\item[\texttt{Dex}]This is Dex described inside method body
\item[\texttt{NoDescr}]
\item[\texttt{Overloaded}]This is overloaded proc {\#}1
\item[\texttt{Overloaded}]This is overloaded proc {\#}2
\item[\texttt{:=}]This is assignment operator
\end{description}
