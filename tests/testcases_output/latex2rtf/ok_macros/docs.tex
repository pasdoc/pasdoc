...
\end{description}
\begin{description}
\item[\texttt{MyProc1}]Below is an example of a very bad and confusing (but valid) macro usage.
\item[\texttt{MyProc2}]This is very stupid way to declare a procedure
\item[\texttt{Foo}]
\item[\texttt{MyProc3}]
