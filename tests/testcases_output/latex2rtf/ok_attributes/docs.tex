...
\section{Overview}
\begin{description}
\item[\texttt{\begin{ttfamily}NonEmptyString\end{ttfamily} Class}]Delphi attributes test from http://www.malcolmgroves.com/blog/?p=530 Attribute class, without Attribute suffix, PasDoc should link to it
...
\item[\texttt{\begin{ttfamily}TMyClass1\end{ttfamily} Class}]Tests from https://github.com/pasdoc/pasdoc/issues/179
