...
begin
  ...
  FTranslation[trHeadlineFunctionsAndProcedures] :=
    'Todas as funÁıes e procedimentos';
  // or:
...
//  FTranslation[trGvClasses] := 'Classes hierarchy graph';
  ...
  FTranslation[trHeadlineFunctionsAndProcedures] :=
    'Toutes les fonctions et procÈdures';
...
//  FTranslation[trGvClasses] := 'Classes hierarchy graph';
   ...
   FTranslation[trWarningOverwrite] :=
     'Vigy·zat: Nem szerkesztendı file - ez a file automatikusan kÈsz¸lt, valÛszÌn˚leg fel¸lÌr·sra ker¸lne';
