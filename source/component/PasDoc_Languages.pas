...
//  FTranslation[trGvClasses] := 'Classes hierarchy graph';
  ...
  FTranslation[trSummaryCio] := 'Podsumowanie klas, interfejsÛw i obiektÛw';

  FTranslation[trWarningOverwrite] :=
    'Uwaga, nie modyfikuj - ten plik zosta≥ wygenerowany przez automat i moøe zostaÊ nadpisany';

  FTranslation[trGeneratedBy] := 'Wygenerowane przez';
  FTranslation[trOnDateTime] := ' ó ';
end;
