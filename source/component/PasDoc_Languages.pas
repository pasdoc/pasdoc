{ @abstract(PasDoc language definitions and translations.)
  ...
  @author(Peter äimkoviË <simkovic_jr@manal.sk> (Slovak translation))
  @author(Peter Thˆrnqvist <pt@timemetrics.se> (Swedish translation))
  ...
  @author(Grzegorz Skoczylas <gskoczylas@rekord.pl> (corrected Polish translation))
  @author(JÛn·s Gergı <jonas.gergo@ch...> (Hungarian translation))
...
begin
  ...
  FTranslation[trProtected] := 'ZaötiÊen';
  ...
  FTranslation[trWarningOverwrite] :=
    'Upozorenje: Ne mjenjajte fajl - ovaj fajl je kreiran automatski i velika je vjerovatnoÊa da Êe biti prepisan';
...
begin
  ...
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trMethods] := 'MÈtodos';
  FTranslation[trLastModified] := '⁄ltima modificaÁ„o';
  ...
  FTranslation[trGvUses] := 'Diagrama de dependÍncias de units';
  ...
  FTranslation[trHeadlineFunctionsAndProcedures] := 'Todas as funÁıes e procedimentos';
  ...
  FTranslation[trDeprecated] := 'este sÌmbolo est· depreciado';
  FTranslation[trPlatformSpecific] := 'este sÌmbolo È especÌfico para alguma plataforma';
  FTranslation[trLibrarySpecific] := 'este sÌmbolo È especÌfico para alguma biblioteca';
  FTranslation[trIntroduction] := 'Introduction'; // TODO: translate
  FTranslation[trConclusion] := 'Conclusion'; // TODO: translate
  FTranslation[trSearch] := 'Search'; // TODO: translate
  FTranslation[trSeeAlso] := 'See also'; // TODO: translate
...
begin
  ...
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trMethods] := 'Mätodes';
  ...
  FTranslation[trGvClasses] := 'Classes hierarchy graph'; // TODO: translate
  FTranslation[trWarningOverwrite] :=
    'Atenci¢, no editar - aquest fitxer ha estat creat automaticament i serÖ sobrescrit';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
...
begin
  FTranslation[trAuthor] := 'ß@™Ã';
  FTranslation[trAuthors] := 'ß@™Ã∏s';
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated'; // TODO: translate
  FTranslation[trPlatformSpecific] := 'this symbol is specific to some platform'; // TODO: translate
...
begin
  FTranslation[trAuthor] := 'Auteur';
  FTranslation[trAuthors] := 'Auteurs';
  FTranslation[trAutomated] := 'AutomatisÈ';
  FTranslation[trCio] := 'Classes, interfaces, structures et objets';
  FTranslation[trClass] := 'Classe';
  FTranslation[trClasses] := 'Classes';
  FTranslation[trClassHierarchy] := 'HiÈrarchie des classes';
  FTranslation[trConstants] := 'Constantes';
  ...
  FTranslation[trUnits] := 'UnitÈs';
  FTranslation[trVariables] := 'Variables';
  FTranslation[trGvUses] := 'Graphique de dÈpendance d''unitÈs';
  FTranslation[trGvClasses] := 'Graphique de hiÈrarchie des classes';
  ...
  FTranslation[trHeadlineFunctionsAndProcedures] := 'Toutes les fonctions et procÈdures';
  FTranslation[trHeadlineIdentifiers] := 'Tous les identificateurs';
  FTranslation[trHeadlineTypes] := 'Tous les types';
  FTranslation[trHeadlineUnits] := 'Toutes les unitÈs';
  ...
  FTranslation[trWarningOverwrite] :=
    'Attention, ne pas Èdtier - ce fichier est crÈÈ automatiquement et va Ítre ÈcrasÈ';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trGeneratedBy] := 'Produit par';
  FTranslation[trOnDateTime] := 'le';
  FTranslation[trDeprecated] := 'ce symbole est dÈsapprouvÈ';
  FTranslation[trPlatformSpecific] := 'ce symbole est spÈcifique ‡ une plateforme d''exÈcution';
  FTranslation[trLibrarySpecific] := 'ce symbole est spÈcifique ‡ une certaine bibliothËque';
  FTranslation[trIntroduction] := 'Introduction'; // TODO: translate
  FTranslation[trConclusion] := 'Conclusion'; // TODO: translate
...
begin
  ...
  FTranslation[trLastModified] := 'Letzte ƒnderung';
  FTranslation[trName] := 'Name';
  ...
  FTranslation[trWarningOverwrite] :=
    'Achtung: Nicht ‰ndern - diese Datei wurde automatisch erstellt und wird mˆglicherweise ¸berschrieben';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
...
begin
  ...
  FTranslation[trWarningOverwrite] :=
    'Attenzione: Non modificare - questo file Ë stato generato automaticamente e verr‡ probabilmente sovrascritto';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated'; // TODO: translate
...
begin
  ...
  FTranslation[trExceptionsRaised] := 'Generowane wyjπtki';
  ...
  FTranslation[trVisibility] := 'WidocznoúÊ';
  ...
  FTranslation[trOverview] := 'Przeglπd';
  FTranslation[trPrivate] := 'Prywatne';
  FTranslation[trProperties] := 'W≥aúciwoúci';
  FTranslation[trProtected] := 'Chronione';
  FTranslation[trPublic] := 'Publiczne';
  FTranslation[trImplicit] := 'Domyúlne';
  ...
  FTranslation[trGvUses] := 'Graf zaleønoúci modu≥Ûw';
  ...
  FTranslation[trSummaryCio] := 
    'Podsumowanie klas, interfejsÛw, obiektÛw i rekordÛw';
  FTranslation[trWarningOverwrite] :=
    'Uwaga, nie modyfikuj - ten plik zosta≥ wygenerowany automatycznie i moøe zostaÊ nadpisany';
  FTranslation[trWarning] := 'Uwaga';
  FTranslation[trGeneratedBy] := 'Wygenerowane przez';
  FTranslation[trOnDateTime] := ' - ';
  FTranslation[trDeprecated] := 'odradza siÍ uøywania tego identyfikatora';
  FTranslation[trPlatformSpecific] := 'ten identyfikator jest zaleøny od platformy';
  FTranslation[trLibrarySpecific] := 'ten identyfikator jest zaleøny od biblioteki';
  FTranslation[trIntroduction] := 'WstÍp';
  FTranslation[trConclusion] := 'Podsumowanie';
  FTranslation[trSearch] := 'Szukaj';
  FTranslation[trSeeAlso] := 'Zobacz takøe';
  FTranslation[trValues] := 'Wartoúci';
  FTranslation[trNoCIOs] := 'Modu≥ nie zawiera øadnych klas, interfejsÛw, obiektÛw ani rekordÛw.';
  FTranslation[trNoCIOsForHierarchy] := 'Modu≥ nie zawiera øadnych klas, interfejsÛw ani obiektÛw.';
  FTranslation[trNoTypes] := 'Modu≥ nie zawiera øadnych typÛw.';
  FTranslation[trNoVariables] := 'Modu≥ nie zawiera øadnych zmiennych.';
  FTranslation[trNoConstants] := 'Modu≥ nie zawiera øadnych sta≥ych.';
  FTranslation[trNoFunctions] := 'Modu≥ nie zawiera øadnych funkcji ani podprogramÛw.';
  FTranslation[trNoIdentifiers] := 'Modu≥ nie zawiera øadnych identyfikatorÛw.';
  FTranslation[trProgram] := 'Program';
end;
...
begin
  ...
  FTranslation[trLegend] := 'Legenda';
  FTranslation[trMarker] := 'Kolor';
  FTranslation[trVisibility] := 'Widoczno∂Ê';
  FTranslation[trMethods] := 'Metody';
  FTranslation[trLastModified] := 'Ostatnia modyfikacja';
  FTranslation[trName] := 'Nazwa';
  FTranslation[trNone] := 'Brak';
  ...
  FTranslation[trUnits] := 'Modu≥y';
  FTranslation[trVariables] := 'Zmienne';
  FTranslation[trGvUses] := 'Graf zaleøno∂ci modu≥Ûw';
  FTranslation[trGvClasses] := 'Graf dziedziczenia klas';
  FTranslation[trHeadlineCio] := 'Wszystkie klasy, interfejsy, obiekty i rekordy';
  FTranslation[trHeadlineConstants] := 'Wszystkie sta≥e';
  FTranslation[trHeadlineFunctionsAndProcedures] := 'Wszystkie podprogramy';
...
begin
  FTranslation[trAuthor] := '¿‚ÚÓ';
  FTranslation[trAuthors] := '¿‚ÚÓ˚';
  FTranslation[trCio] := ' Î‡ÒÒ˚, ËÌÚÂÙÂÈÒ˚ Ë Ó·˙ÂÍÚ˚';
  FTranslation[trClass] := ' Î‡ÒÒ';
  FTranslation[trClasses] := ' Î‡ÒÒ˚';
  ...
  FTranslation[trFunctionsAndProcedures] := 'œÓˆÂ‰Û˚ Ë ÙÛÌÍˆËË';
  FTranslation[trHelp] := 'Help';
    // Untranslated to avoid Russian file name for css
  FTranslation[trHierarchy] := '»Â‡ıËˇ';
  FTranslation[trIdentifiers] := '»‰ÂÌÚËÙËÍ‡ÚÓ˚';
  FTranslation[trInterface] := '»ÌÚÂÙÂÈÒ';
  FTranslation[trLegend] := 'Œ·ÓÁÌ‡˜ÂÌËˇ';
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trLastModified] := 'œÓÒÎÂ‰ÌÂÂ ËÁÏÂÌÂÌËÂ';
  FTranslation[trMethods] := 'ÃÂÚÓ‰˚';
  FTranslation[trName] := '»Ïˇ';
  FTranslation[trNone] := 'ÕÂÚ';
  FTranslation[trObject] := 'Œ·˙ÂÍÚ';
  FTranslation[trObjects] := 'Œ·˙ÂÍÚ˚';
  FTranslation[trOverview] := 'Œ·ÁÓ';
  FTranslation[trPrivate] := 'Private';
  FTranslation[trProperties] := '—‚ÓÈÒÚ‚‡';
  FTranslation[trProtected] := 'Protected';
  FTranslation[trPublic] := 'Public';
  FTranslation[trImplicit] := 'Implicit';
  FTranslation[trPublished] := 'Published';
  FTranslation[trType] := '“ËÔ';
  FTranslation[trTypes] := '“ËÔ˚';
  FTranslation[trUnit] := 'ÃÓ‰ÛÎ¸';
  FTranslation[trUnits] := 'ÃÓ‰ÛÎË';
  FTranslation[trVariables] := 'œÂÂÏÂÌÌ˚Â';
  FTranslation[trGvUses] := 'Unit dependency graph'; // TODO: translate
  FTranslation[trGvClasses] := 'Classes hierarchy graph'; // TODO: translate
  FTranslation[trWarningOverwrite] :=
    'œÂ‰ÛÔÂÊ‰ÂÌËÂ: ÌÂ Â‰‡ÍÚËÓ‚‡Ú¸ - ˝ÚÓÚ Ù‡ÈÎ ÒÓÁ‰‡Ì ‡‚ÚÓÏ‡ÚË˜ÂÒÍË Ë ÏÓÊÂÚ ·˚Ú¸ ËÁÏÂÌ∏Ì ·ÂÁ ÔÂ‰ÛÔÂÊ‰ÂÌËˇ';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trHeadlineCio] := '¬ÒÂ ÍÎ‡ÒÒ˚, ËÌÚÂÙÂÈÒ˚ Ë Ó·˙ÂÍÚ˚';
  FTranslation[trHeadlineConstants] := '¬ÒÂ ÍÓÌÒÚ‡ÌÚ˚';
  FTranslation[trHeadlineFunctionsAndProcedures] := '¬ÒÂ ÔÓˆÂ‰Û˚ Ë ÙÛÌÍˆËË';
  FTranslation[trHeadlineIdentifiers] := '¬ÒÂ Ë‰ÂÌÚËÙËÍ‡ÚÓ˚';
  FTranslation[trHeadlineTypes] := '¬ÒÂ ÚËÔ˚';
  FTranslation[trHeadlineUnits] := '¬ÒÂ ÏÓ‰ÛÎË';
  FTranslation[trHeadlineVariables] := '¬ÒÂ ÔÂÂÏÂÌÌ˚Â';
  FTranslation[trSummaryCio] := '—ÔËÒÓÍ ÍÎ‡ÒÒÓ‚, ËÌÚÂÙÂÈÒÓ‚ Ë Ó·˙ÂÍÚÓ‚';
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated'; // TODO: translate
  FTranslation[trPlatformSpecific] := 'this symbol is specific to some platform'; // TODO: translate
...
begin
  FTranslation[trAuthor] := 'Ä¢‚Æ‡';
  FTranslation[trAuthors] := 'Ä¢‚Æ‡Î';
  FTranslation[trCio] := 'ä´†··Î, ®≠‚•‡‰•©·Î ® Æ°Í•™‚Î';
  FTranslation[trClass] := 'ä´†··';
  FTranslation[trClasses] := 'ä´†··Î';
  FTranslation[trConstants] := 'äÆ≠·‚†≠‚Î';
  ...
  FTranslation[trHelp] := 'Help';
    // Untranslated to avoid Russian file name for css
  FTranslation[trHierarchy] := 'à•‡†‡Â®Ô';
  FTranslation[trIdentifiers] := 'à§•≠‚®‰®™†‚Æ‡Î';
  FTranslation[trInterface] := 'à≠‚•‡‰•©·';
  FTranslation[trLegend] := 'é°Æß≠†Á•≠®Ô';
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trLastModified] := 'èÆ·´•§≠•• ®ß¨•≠•≠®•';
  FTranslation[trMethods] := 'å•‚Æ§Î';
  FTranslation[trName] := 'à¨Ô';
  FTranslation[trNone] := 'ç•‚';
  FTranslation[trObject] := 'é°Í•™‚';
  FTranslation[trObjects] := 'é°Í•™‚Î';
  FTranslation[trOverview] := 'é°ßÆ‡';
  FTranslation[trPrivate] := 'Private';
  FTranslation[trProperties] := 'ë¢Æ©·‚¢†';
  FTranslation[trProtected] := 'Protected';
  FTranslation[trPublic] := 'Public';
  FTranslation[trImplicit] := 'Implicit';
  FTranslation[trPublished] := 'Published';
  FTranslation[trType] := 'í®Ø';
  FTranslation[trTypes] := 'í®ØÎ';
  FTranslation[trUnit] := 'åÆ§„´Ï';
  FTranslation[trUnits] := 'åÆ§„´®';
  FTranslation[trVariables] := 'è•‡•¨•≠≠Î•';
  FTranslation[trGvUses] := 'Unit dependency graph'; // TODO: translate
  FTranslation[trGvClasses] := 'Classes hierarchy graph'; // TODO: translate
  FTranslation[trWarningOverwrite] :=
    'è‡•§„Ø‡•¶§•≠®•: ≠• ‡•§†™‚®‡Æ¢†‚Ï - Ì‚Æ‚ ‰†©´ ·Æß§†≠ †¢‚Æ¨†‚®Á•·™® ® ¨Æ¶•‚ °Î‚Ï ®ß¨•≠Ò≠ °•ß Ø‡•§„Ø‡•¶§•≠®Ô';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trHeadlineCio] := 'Ç·• ™´†··Î, ®≠‚•‡‰•©·Î ® Æ°Í•™‚Î';
  FTranslation[trHeadlineConstants] := 'Ç·• ™Æ≠·‚†≠‚Î';
  FTranslation[trHeadlineFunctionsAndProcedures] := 'Ç·• Ø‡ÆÊ•§„‡Î ® ‰„≠™Ê®®';
  FTranslation[trHeadlineIdentifiers] := 'Ç·• ®§•≠‚®‰®™†‚Æ‡Î';
  FTranslation[trHeadlineTypes] := 'Ç·• ‚®ØÎ';
  FTranslation[trHeadlineUnits] := 'Ç·• ¨Æ§„´®';
  FTranslation[trHeadlineVariables] := 'Ç·• Ø•‡•¨•≠≠Î•';
  FTranslation[trSummaryCio] := 'ëØ®·Æ™ ™´†··Æ¢, ®≠‚•‡‰•©·Æ¢ ® Æ°Í•™‚Æ¢';
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated';
  FTranslation[trPlatformSpecific] := 'this symbol is specific to some platform';
...
begin
  FTranslation[trAuthor] := '·◊‘œ“';
  FTranslation[trAuthors] := '·◊‘œ“Ÿ';
  FTranslation[trCio] := 'ÎÃ¡””Ÿ, …Œ‘≈“∆≈ ”Ÿ … œ¬ﬂ≈À‘Ÿ';
  FTranslation[trClass] := 'ÎÃ¡””';
  FTranslation[trClasses] := 'ÎÃ¡””Ÿ';
  FTranslation[trConstants] := 'ÎœŒ”‘¡Œ‘Ÿ';
  FTranslation[trCreated] := 'Ûœ⁄ƒ¡Œœ';
  ...
  FTranslation[trHelp] := 'Help';
    // Untranslated to avoid Russian file name for css
  FTranslation[trHierarchy] := 'È≈“¡“»…—';
  FTranslation[trIdentifiers] := 'Èƒ≈Œ‘…∆…À¡‘œ“Ÿ';
  FTranslation[trInterface] := 'ÈŒ‘≈“∆≈ ”';
  FTranslation[trLegend] := 'Ô¬œ⁄Œ¡ﬁ≈Œ…—';
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trLastModified] := 'œ”Ã≈ƒŒ≈≈ …⁄Õ≈Œ≈Œ…≈';
  FTranslation[trMethods] := 'Ì≈‘œƒŸ';
  FTranslation[trName] := 'ÈÕ—';
  FTranslation[trNone] := 'Ó≈‘';
  FTranslation[trObject] := 'Ô¬ﬂ≈À‘';
  FTranslation[trObjects] := 'Ô¬ﬂ≈À‘Ÿ';
  FTranslation[trOverview] := 'Ô¬⁄œ“';
  FTranslation[trPrivate] := 'Private';
  FTranslation[trProperties] := 'Û◊œ ”‘◊¡';
  FTranslation[trProtected] := 'Protected';
  FTranslation[trPublic] := 'Public';
  FTranslation[trImplicit] := 'Implicit';
  FTranslation[trPublished] := 'Published';
  FTranslation[trType] := 'Ù…–';
  FTranslation[trTypes] := 'Ù…–Ÿ';
  FTranslation[trUnit] := 'Ìœƒ’Ãÿ';
  FTranslation[trUnits] := 'Ìœƒ’Ã…';
  FTranslation[trVariables] := '≈“≈Õ≈ŒŒŸ≈';
  FTranslation[trGvUses] := 'Unit dependency graph'; // TODO: translate
  FTranslation[trGvClasses] := 'Classes hierarchy graph'; // TODO: translate
  FTranslation[trWarningOverwrite] :=
    '“≈ƒ’–“≈÷ƒ≈Œ…≈: Œ≈ “≈ƒ¡À‘…“œ◊¡‘ÿ - ‹‘œ‘ ∆¡ Ã ”œ⁄ƒ¡Œ ¡◊‘œÕ¡‘…ﬁ≈”À… … Õœ÷≈‘ ¬Ÿ‘ÿ …⁄Õ≈Œ£Œ ¬≈⁄ –“≈ƒ’–“≈÷ƒ≈Œ…—';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trHeadlineCio] := '˜”≈ ÀÃ¡””Ÿ, …Œ‘≈“∆≈ ”Ÿ … œ¬ﬂ≈À‘Ÿ';
  FTranslation[trHeadlineConstants] := '˜”≈ ÀœŒ”‘¡Œ‘Ÿ';
  FTranslation[trHeadlineFunctionsAndProcedures] := '˜”≈ –“œ√≈ƒ’“Ÿ … ∆’ŒÀ√……';
  FTranslation[trHeadlineIdentifiers] := '˜”≈ …ƒ≈Œ‘…∆…À¡‘œ“Ÿ';
  FTranslation[trHeadlineTypes] := '˜”≈ ‘…–Ÿ';
  FTranslation[trHeadlineUnits] := '˜”≈ Õœƒ’Ã…';
  FTranslation[trHeadlineVariables] := '˜”≈ –≈“≈Õ≈ŒŒŸ≈';
  FTranslation[trSummaryCio] := 'Û–…”œÀ ÀÃ¡””œ◊, …Œ‘≈“∆≈ ”œ◊ … œ¬ﬂ≈À‘œ◊';
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated';
  FTranslation[trPlatformSpecific] := 'this symbol is specific to some platform';
...
begin
  ...
  FTranslation[trConstants] := 'Konötanty';
  ...
  FTranslation[trMethods] := 'MetÛdy';
  FTranslation[trName] := 'Meno';
  FTranslation[trNone] := 'NiË';
  FTranslation[trObject] := 'Objekt';
  FTranslation[trObjects] := 'Objekty';
  FTranslation[trOverview] := 'Overview';
  FTranslation[trProperties] := 'Moûnosti';
  FTranslation[trType] := 'Typ';
  FTranslation[trTypes] := 'Typy';
  FTranslation[trUnit] := 'Jednotka';
  FTranslation[trUnits] := 'Jednotky';
  FTranslation[trVariables] := 'PremennÈ';
  FTranslation[trGvUses] := 'Unit dependency graph'; // TODO: translate
  FTranslation[trGvClasses] := 'Classes hierarchy graph'; // TODO: translate
  FTranslation[trWarningOverwrite] :=
    'Upozornenie: Needitujte - tento s˙bor bol vytvoren˝ automaticky a je pravdepodobnÈ, ûe bude prepÌsan˝';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trHeadlineCio] := 'Vöetky triedy, interfejsy a objekty';
  FTranslation[trHeadlineConstants] := 'Vöetky konötanty';
  FTranslation[trHeadlineFunctionsAndProcedures] :=
    'Vöetky funkcie a proced˙ry';
  FTranslation[trHeadlineIdentifiers] := 'Vöetky identifik·tory';
  FTranslation[trHeadlineTypes] := 'Vöetky typy';
  FTranslation[trHeadlineUnits] := 'Vöetky jednotky';
  FTranslation[trHeadlineVariables] := 'Vöetky premennÈ';
...
begin
  ...
  FTranslation[trClass] := 'Clase';
  FTranslation[trClasses] := 'Clases';
  FTranslation[trClassHierarchy] := 'JerarquÌa de clases';
  FTranslation[trConstants] := 'Constantes';
  ...
  FTranslation[trHierarchy] := 'JerarquÌa';
  FTranslation[trIdentifiers] := 'Identificadores';
  FTranslation[trInterface] := 'Interface';
  ...
  FTranslation[trMethods] := 'MÈtodos';
  FTranslation[trLastModified] := '⁄ltima modificaciÛn';
  ...
  FTranslation[trGvClasses] := 'Gr·fico de la jerarquÌa de clases';
  ...
  FTranslation[trWarningOverwrite] :=  'AtenciÛn, no editar - este fichero ha sido creado automaticamente y puede ser sobrescrito';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trGeneratedBy] := 'Generador por';
  FTranslation[trOnDateTime] := 'a';
  FTranslation[trDeprecated] := 'Este sÌmbolo est· obsoleto';
  FTranslation[trPlatformSpecific] := 'Este sÌmbolo es especÌfico para alguna plataforma';
  FTranslation[trLibrarySpecific] := 'Este sÌmbolo es especÌfico para alguna librerÌa';
  FTranslation[trIntroduction] := 'IntroducciÛn';
  FTranslation[trConclusion] := 'ConclusiÛn';
...
begin
  FTranslation[trAuthor] := 'Fˆrfattare';
  FTranslation[trAuthors] := 'Fˆrfattare';
  ...
  FTranslation[trIdentifiers] := 'Identifiers';
  FTranslation[trInterface] := 'Interface';
  FTranslation[trLegend] := 'Fˆrklaring';
  FTranslation[trMarker] := 'Marker'; // TODO: translate
  FTranslation[trVisibility] := 'Visibility'; // TODO: translate
  FTranslation[trMethods] := 'Metoder';
  ...
  FTranslation[trWarningOverwrite] :=
    'Varning: ‰ndra inte denna fil manuellt - filen har skapats automatiskt och kommer troligen att skrivas ˆver vid ett senare tilf‰lle';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trGeneratedBy] := 'Generated by'; // TODO: translate
  FTranslation[trOnDateTime] := 'on'; // TODO: translate
  FTranslation[trDeprecated] := 'this symbol is deprecated'; // TODO: translate
...
begin
  FTranslation[trAuthor] := 'Szerzı';
  FTranslation[trAuthors] := 'Szerzık';
  FTranslation[trAutomated] := 'Automatikus';
  FTranslation[trCio] := 'Oszt·lyok, KapcsolÛd·si fel¸letek Ès Objektumok';
  ...
  FTranslation[trCreated] := 'KÈsz¸lt';
  FTranslation[trDeclaration] := 'Deklar·ciÛ';
  FTranslation[trDescription] := 'MegjegyzÈs';
  FTranslation[trParameters] := 'ParamÈterek';
  FTranslation[trReturns] := 'VisszatÈrÈsi ÈrtÈkek';
  FTranslation[trExceptions] := 'KivÈtelek';
  FTranslation[trExceptionsRaised] := 'KivÈtelek kiemelÈse';
  FTranslation[trEnum] := 'Felsorol·sok';
  FTranslation[trDispInterface] := 'KÈpernyı fel¸letek';
  FTranslation[trFields] := 'Mezık';
  FTranslation[trFunctionsAndProcedures] := 'F¸ggvÈnyek Ès Elj·r·sok';
  FTranslation[trHelp] := 'S˙gÛ';
  FTranslation[trHierarchy] := 'Hierarchia';
  FTranslation[trIdentifiers] := 'AzonosÌtÛk';
  FTranslation[trInterface] := 'KapcsolÛd·si fel¸let';
  FTranslation[trLegend] := 'TˆrtÈnet';
  FTranslation[trMarker] := 'Jelzı';
  FTranslation[trVisibility] := 'L·thatÛs·g';
  FTranslation[trMethods] := 'MetÛdusok';
  FTranslation[trLastModified] := 'UtolsÛ mÛdosÌt·s';
  FTranslation[trName] := 'NÈv';
  FTranslation[trNone] := 'Nincs';
  FTranslation[trObject] := 'Objektum';
  FTranslation[trObjects] := 'Objektumok';
  FTranslation[trOverview] := '¡ttekintÈs';
  FTranslation[trPrivate] := 'Priv·t';
  FTranslation[trProperties] := 'Tulajdons·gok';
  FTranslation[trProtected] := 'VÈdett';
  FTranslation[trPublic] := 'Publikus';
  FTranslation[trImplicit] := 'Implicit';
  FTranslation[trPublished] := 'Publik·lt';
  FTranslation[trType] := 'TÌpus';
  FTranslation[trTypes] := 'TÌpusok';
  FTranslation[trUnit] := 'EgysÈg';
  FTranslation[trUnits] := 'EgysÈgek';
  FTranslation[trVariables] := 'V·ltozÛk';
  FTranslation[trGvUses] := 'EgysÈg f¸ggısÈgi gr·f';
  FTranslation[trGvClasses] := 'Oszt·ly hierarchia gr·f';
  FTranslation[trHeadlineCio] := '÷sszes Oszt·ly, KapcsolÛd·si fel¸let Ès Objektumok';
  FTranslation[trHeadlineConstants] := '÷sszes Kontans';
  FTranslation[trHeadlineFunctionsAndProcedures] := '÷sszes F¸ggvÈny Ès Elj·r·s';
  FTranslation[trHeadlineIdentifiers] := '÷sszes AzonosÌtÛ';
  FTranslation[trHeadlineTypes] := '÷sszes TÌpus';
  FTranslation[trHeadlineUnits] := '÷sszes EgysÈg';
  FTranslation[trHeadlineVariables] := '÷sszes V·ltozÛ';
  FTranslation[trSummaryCio] := '÷szefoglalÛ az Oszt·lyokrÛl, Kapcsold·si fel¸letekrıl Ès ObjektumokrÛl';
  FTranslation[trWarningOverwrite] := 'Vigy·zat: Nem szerkesztendı file - ez a file automatikusan kÈsz¸lt, valÛszÌn˚leg fel¸lÌr·sra ker¸lne';
  FTranslation[trWarning] := 'Warning';  // TODO: translate
  FTranslation[trGeneratedBy] := 'KÈszÌtette';
  FTranslation[trOnDateTime] := ''; //none in Hungarian language
  FTranslation[trDeprecated] := 'ez az azonosÌtÛ ÈrtÈk nÈlk¸li';
  FTranslation[trPlatformSpecific] := 'ez az azonosÌtÛ sz¸ksÈges nÈmely platform sz·m·ra';
  FTranslation[trLibrarySpecific] := 'ez az azonosÌtÛ sz¸ksÈges nÈmely library sz·m·ra';
  FTranslation[trIntroduction] := 'Bevezetı';
  FTranslation[trConclusion] := '÷sszefoglalÛ';
  FTranslation[trSearch] := 'KeresÈs';
  FTranslation[trSeeAlso] := 'L·sd mÈg';
  FTranslation[trValues] := '…rtÈkek';
  FTranslation[trNoCIOs] := 'Az egysÈg nem tartalmaz oszt·lyt, interfÈszt, objektumot, vagy rekordot.';
  FTranslation[trNoCIOsForHierarchy] := 'Az egysÈg nem tartalmaz oszt·lyt, interfÈszt vagy objektumot.';
  FTranslation[trNoTypes] := 'Az egysÈg nem tartalmaz tÌpusokat';
  FTranslation[trNoVariables] := 'Az egysÈg nem tartalmaz v·ltozÛkat.';
  FTranslation[trNoConstants] := 'Az egysÈg nem tartalmaz konstansokat.';
  FTranslation[trNoFunctions] := 'Az egysÈg nem tartalmaz f¸ggvÈnyeket vagy elj·r·sokat.';
  FTranslation[trNoIdentifiers] := 'Az egysÈg nem tartalmaz azonosÌtÛkat.';
  FTranslation[trProgram] := 'Program';
end;
