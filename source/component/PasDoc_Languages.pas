{ @abstract(PasDoc language definitions and translations.)
  ...
  @author(Peter äimkoviË <simkovic_jr AT manal.sk> (Slovak translation))
  @author(Peter Thˆrnqvist <pt AT timemetrics.se> (Swedish translation))
  ...
  @author(JÛn·s Gergı <jonas.gergo AT ch...> (Hungarian translation))
